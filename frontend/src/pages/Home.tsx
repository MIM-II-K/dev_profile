...
const PROJECTS = [
  ...
  },
  {
    title: "NGAU Bazaar",
    description:
      "Scalable backend system for a multi-vendor marketplace with real-time communication capabilities. Implements WebSocket-based multi-room chat and Redis Pub/Sub for cross-instance synchronization, enabling horizontal scaling without sticky sessions. Includes persistent messaging with PostgreSQL.",
    stack: [
      "FastAPI",
      "PostgreSQL",
      "Redis",
  ...
  },
  {
    ...
    description:
      "Full-featured e-commerce backend system supporting product catalog, inventory management, order lifecycle, and Stripe payment integration. Includes asynchronous background tasks for order confirmation emails and inventory reconciliation to improve performance and responsiveness.",
  ...
  },
  {
    ...
    description:
      "Low-latency machine learning inference API built around Scikit-learn models. Features Redis-backed caching to eliminate redundant computations, versioned inference endpoints for model lifecycle management, and structured logging for monitoring model performance and drift signals.",
  ...
  },
  {
    ...
    description:
      "High-throughput URL shortening service optimized for sub-millisecond redirect resolution using Redis in-memory storage. Includes asynchronous analytics pipeline for click tracking and reporting, designed for scalable, event-driven traffic handling.",
    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-white/5">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <div
            className="flex items-center gap-2 font-mono text-primary font-bold text-xl cursor-pointer"
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium font-mono text-muted-foreground">
            ...
            <Button
              size="sm"
              variant="outline"
              className="gap-2 border-primary/40 text-primary hover:bg-primary/10 font-mono"
      ...
      <main>
        ...
        >
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              >
                Backend engineer with a focus on building reliable,
                high-throughput APIs and distributed systems using{" "}
                <strong className="text-foreground font-medium">FastAPI</strong>{" "}
                and{" "}
                <strong className="text-foreground font-medium">Python</strong>.
                I care deeply about correctness, performance, and
              ...
              >
                ...
                <Button
                  variant="outline"
                  onClick={() => setResumeOpen(true)}
                  className="gap-2 h-12 px-6 border-primary/40 text-primary hover:bg-primary/10"
                ...
                <Button
                  variant="outline"
                  onClick={() => scrollTo("contact")}
                  className="gap-2 h-12 px-6 border-white/10 hover:bg-white/5"
        ...
        <section
          id="about"
          className="py-24 bg-secondary/30 border-y border-white/5"
        >
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
                  <p>
                    I'm a backend software engineer with professional experience
                    designing and shipping production APIs using{" "}
                    ...
                    . My work spans authentication services, real-time data
                    pipelines, and ML inference APIs — systems where correctness
                    and latency both matter.
                  </p>
                  <p>
                    I approach every project with the same discipline: typed
                    interfaces via Pydantic, async-first I/O, clean layered
                    architecture, and observable deployments. I write code that
                    other engineers can read, extend, and trust in production.
                  </p>
                  <p>
                    Outside of work, I contribute to open-source tooling, write
                    technical articles on FastAPI patterns, and continuously
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-6 bg-background rounded-lg border border-white/5 flex flex-col gap-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      RESTful & WebSocket architectures
                    </p>
                  </div>
                  <div className="p-6 bg-background rounded-lg border border-white/5 flex flex-col gap-3">
                    ...
                    <Card className="bg-secondary/20 border-white/5 flex flex-col hover:border-primary/50 hover:shadow-[0_0_30px_-8px_hsl(var(--primary)/0.3)] transition-all group h-full">
                      ...
                      <CardContent className="flex-grow">
                        <div className="flex flex-wrap gap-2 font-mono text-xs">
                          {project.stack.map((tech, j) => (
                            <span
                              key={j}
                              className="px-2 py-1 rounded bg-background text-primary border border-primary/20"
                            >
                              {tech}
                            </span>
                          ))}
                      ...
                      <CardFooter className="flex gap-3 pt-4 border-t border-white/5">
                        <Dialog>
                          <DialogTrigger asChild>
                            <Button
                              variant="secondary"
                              size="sm"
                              className="gap-2 w-full bg-background hover:bg-white/5 text-foreground"
                              data-testid={`btn-demo-${i}`}
                            >
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="gap-2 w-full border-white/10 hover:bg-white/5"
                          onClick={() =>
                            window.open("https://github.com", "_blank")
                          }
                          data-testid={`btn-github-${i}`}
                        >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    {BACKEND_SKILLS.map((skill, i) => (
                      <div
                        key={i}
                        className="flex flex-col items-center gap-4 p-6 rounded-xl bg-background border border-white/5 hover:border-primary/30 transition-all hover:-translate-y-1"
                      >
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <div className="flex justify-center gap-6 mt-12">
                {/* GitHub Link */}
                <a
                  href="https://github.com/MIMIIKK"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-full bg-secondary/50 text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors border border-white/5"
                ...
                {/* Email Link (This one is already good, just change the email address) */}
                <a
                  href="mailto:ennzaen@gmail.com"
                  className="p-3 rounded-full bg-secondary/50 text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors border border-white/5"
          ...
          <div className="space-y-8 py-2 font-sans">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 mt-3 text-sm text-muted-foreground font-mono">
                <span className="flex items-center gap-1">
                  <Mail className="w-3.5 h-3.5" /> ennzaen@gmail.com
                </span>
                <span className="flex items-center gap-1">
                  <Github className="w-3.5 h-3.5" /> https://github.com/MIMIIKK
                </span>
                <span className="flex items-center gap-1">
                  <Linkedin className="w-3.5 h-3.5" /> linkedin.com/in/ennzaen
                </span>
                <span className="flex items-center gap-1">
                  <Globe className="w-3.5 h-3.5" /> injanthada.com.np
                </span>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Backend software engineer with 4+ years of experience designing
                and delivering production-grade REST APIs and microservices
                using <strong className="text-foreground">FastAPI</strong> and{" "}
                <strong className="text-foreground">Python</strong>. Specializes
                in async Python systems, relational and in-memory data layers
                (PostgreSQL, Redis), and containerized deployments. Consistent
                track record of reducing API latency, improving system
                reliability, and building architectures that scale with product
                demand.
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <Badge
                      variant="outline"
                      className="font-mono text-xs border-white/20 text-muted-foreground shrink-0"
                    >
                      Jan 2024 – Present
                    </Badge>
                  </div>
                  <ul className="mt-3 space-y-1.5 text-sm text-muted-foreground list-none">
                    <li className="flex gap-2">
                      <span className="text-primary mt-1">▸</span> Architected
                      and led delivery of a multi-tenant authentication platform
                      serving 200k+ users, built on FastAPI with JWT rotation
                      and Redis token blacklisting.
                    </li>
                    <li className="flex gap-2">
                      <span className="text-primary mt-1">▸</span> Reduced
                      average API response time by 38% through async SQLAlchemy
                      2.0 migration and strategic query optimization using
                      PostgreSQL EXPLAIN ANALYZE.
                    </li>
                    <li className="flex gap-2">
                      <span className="text-primary mt-1">▸</span> Established
                      team-wide code review standards for Python typing,
                      Pydantic schema design, and FastAPI dependency injection
                      patterns.
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="mt-3 space-y-1.5 text-sm text-muted-foreground list-none">
                    <li className="flex gap-2">
                      <span className="text-primary mt-1">▸</span> Built a
                      real-time WebSocket API supporting 10,000+ concurrent
                      connections, using Redis Pub/Sub for cross-instance
                      message routing.
                    </li>
                    <li className="flex gap-2">
                      <span className="text-primary mt-1">▸</span> Developed an
                      ML model serving layer wrapping Scikit-learn classifiers
                      behind a versioned FastAPI interface with Redis prediction
                      caching.
                    </li>
                    <li className="flex gap-2">
                      <span className="text-primary mt-1">▸</span> Maintained
                      full Docker-based CI/CD pipelines on GitHub Actions,
                      reducing deployment cycle time by 50%.
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="mt-3 space-y-1.5 text-sm text-muted-foreground list-none">
                    <li className="flex gap-2">
                      <span className="text-primary mt-1">▸</span> Contributed
                      to an e-commerce REST API handling product catalog,
                      inventory, and Stripe payment processing.
                    </li>
                    <li className="flex gap-2">
                      <span className="text-primary mt-1">▸</span> Wrote
                      integration tests using pytest and maintained API
                      documentation via OpenAPI schemas.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                {[
                  {
                    label: "Languages",
                    value: "Python, TypeScript, SQL, Bash",
                  },
                  { label: "Backend", value: "FastAPI, SQLAlchemy, Pydantic" },
                  {
                    label: "Frontend",
                    value: "React, React Native, Vite, Bootstrap",
                  },
                  { label: "Databases", value: "PostgreSQL, Redis, SQLite" },
                  {
                    label: "Infrastructure",
                    value: "Docker, Linux, GitHub Actions",
                  },
                  { label: "Protocols", value: "REST, WebSocket, OpenAPI" },
                ].map((item, i) => (
                  <div key={i} className="flex gap-2">
                    <span className="font-mono text-primary text-xs w-28 shrink-0 pt-0.5">
                      {item.label}
                    </span>
      ...
      <footer className="py-8 border-t border-white/5 text-center font-mono text-sm text-muted-foreground bg-background">
        <p className="mt-2 flex items-center justify-center gap-2 opacity-50">
          ...
          Injan Thada &copy; {new Date().getFullYear()}
        </p>
      </footer>
    </div>
  );
